...
#TRAIN_GRAPH_DATASET = [GRAPH_DATASET[p] for p in train]
#TEST_GRAPH_DATASET = [GRAPH_DATASET[p] for p in test]
...
#train_prots = [x.split("_")[0] for x in train]
#test_prots = [x.split("_")[0] for x in test]


#train_pgDataset = ProtGraphDataset('../data', prot_names=train_prots)
#test_pgDataset = ProtGraphDataset('../data', prot_names=test_prots)
#print("-----------------------------------------")
#my_loader_train = DataLoader(train_pgDataset, batch_size=32, shuffle=True, num_workers=8)
#my_loader_test = DataLoader(test_pgDataset, batch_size=32, shuffle=True, num_workers=8)
#print("-----------------------------------------")
...
#utilizzare una metrica per visualizzare le accuratezze... e la bontà delle predizioni dei siti
#top-k-2, top-k-3, top-k-4 ??
